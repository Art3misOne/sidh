...
class SIDHKeyExchange {
  ...
  public F2elm calculateAgreementA (SIDHPrivateKey privKeyA, SIDHPublicKey pubKeyB) {
    ...
    fourIsog.get4Isog (r);
    return fourIsog.jInv();
  }


  public F2elm calculateAgreementB (SIDHPrivateKey privKeyB, SIDHPublicKey pubKeyA) {
